...
type EssentialsProps = {
  data?: {
    type?: string; // optional if you want to support both
    set?: {
      items: DataItem[];
    };
  };
...
const HomiiLogo: React.FC<{ size: string; variant: string }> = ({
  size,
  variant,
}) => (
    ...
    <>
      <div className={styles.landingPageContainer}>
        ...
        <div className={styles.heroContent}>
          ...
          <button className={styles.ctaButton}>{callToActionText}</button>
        </div>

        <section className={styles.contentSection}>
          <h2>{introHeading}</h2>
          <p className={styles.problemStatement}>{introParagraph1}</p>
          <p className={styles.solutionIntro}>{introParagraph2}</p>
        </section>
        ...
        <section className={styles.contentSection}>
          ...
          <p className={styles.problemStatement}>
            This section uses placeholder data to demonstrate how Homii might
            integrate local information, such as interesting places or community
            recommendations, to help you get started in a new location.
          </p>
        ...
        <section className={styles.contentSection}>
          ...
          <p>
            With Homii's essential guides, you're always prepared. Let us help
            you unlock a world of seamless travel and meaningful connections.
          </p>
